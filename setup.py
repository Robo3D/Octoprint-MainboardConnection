...
plugin_identifier = "mainboardconnection"

# The plugin's python package, should be "octoprint_<plugin identifier>",
# has to be unique
plugin_package = "octoprint_mainboardconnection"
...
plugin_name = "OctoPrint-MainboardConnection"
...
plugin_description = "Maintain connection between OctoPrint and the printer"
...
plugin_url = "https://github.com/Robo3D/OctoPrint-MainboardConnection"
